...
<div class="container py-5" style="max-width:760px">
    ...
    <p>iDev Compagnon (module Football) is a web app designed to complement your Football Manager save. It replaces the classic spreadsheet approach and gives you a clean interface to manage your squad, plan transfers, organise your tactical substitutions, track season objectives, and build a career history — all in one place.</p>

    <!-- Getting started -->
    <h5 class="fw-bold mt-4 section-heading">Getting started</h5>
    <ol>
    ...
    <!-- Features -->
    <h5 class="fw-bold mt-4 section-heading">Features</h5>
    ...
    <!-- Data & privacy -->
    <h5 class="fw-bold mt-4 section-heading">Data & privacy</h5>
    ...
    <div class="table-panel mt-2">
        ...
        <div class="p-3 small">
            ...
            <p class="mb-2">iDev Compagnon est une application à usage personnel, hébergée localement sur un serveur privé (WAMP). Aucune donnée n'est envoyée vers un serveur externe ou un service cloud.</p>
    ...
    <!-- Stack -->
    <h5 class="fw-bold mt-4 section-heading">Stack</h5>
