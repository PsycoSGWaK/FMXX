...
$t = [
    ...
    // Objective/result labels (raw values stored in the database)
    'obj_rank_1er'   => '1st',
    'obj_rank_gagner'=> 'Win',
    'obj_rank_finale'=> 'Final',
    'obj_rank_demi'  => 'Semi-final',
    'obj_rank_quarts'=> 'Quarter-final',
    'obj_rank_8eme'  => 'Round of 16',
    'obj_rank_16eme' => 'Round of 32',
    'obj_rank_poules'=> 'Group stage',
    ...
    'role_ST'  => 'Striker',
    'role_FW'  => 'Forward',
    // Translated abbreviations (shown in the selector and glossary; the
    // value saved in the database always stays the EN code, e.g. "CB")
    'role_abbr_GK'  => 'GK',
    'role_abbr_CB'  => 'CB',
    'role_abbr_RB'  => 'RB',
    'role_abbr_LB'  => 'LB',
    ...
    'tactic_sub'      => 'Sub',
    'tactic_supersub' => '3rd choice',
    'tactic_no_squad' => 'Import a squad to set up substitutions.',
    'tactic_no_preset' => 'No tactical style available.',
    'tactic_create' => 'Configure a new tactical style',
    'tactic_name' => 'Tactical style name',
    'tactic_create_help' => 'Choose the position for each of the 11 slots.',
    'tactic_name_poste' => 'Position',
    'tactic_create_submit' => 'Create',
    'tactic_create_error' => 'Could not create the tactical style. Check the name and try again.',
    'tactic_name_taken' => 'A tactical style already has this name. Please choose another one.',
    'tactic_back' => 'Back',
    'tactic_card_add' => 'Add a tactical style',
    'tactic_card_label' => 'Tactic %d',
    'tactic_card_delete' => 'Remove this tactical style',
    'tactic_card_delete_confirm' => 'Remove this tactical style? The lineup (assigned players) will be lost.',
    'tactic_create_and_use' => 'Configure and use a new tactical style',
    'tactic_card_limit' => 'Limit of 5 tactical styles reached. Remove one before adding a new one.',
    'tactic_card_rename' => 'Rename',
    'tactic_card_rename_title' => 'Rename tactical style',
    'tactic_card_rename_placeholder' => 'Leave empty to use the default name',
